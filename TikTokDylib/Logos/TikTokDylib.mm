...
@class TTConcurrentHttpTask; @class AWEFeedTableViewController; @class UIDevice; @class PIPOIAPStoreManager; @class AAWEBootChecker; @class GULAppEnvironmentUtil; @class AWEFeedContainerViewController; @class TTKSettingsViewController; @class NSString; @class TTHttpRequestChromium; @class TTInstallUtil; @class AWEPlayInteractionViewController; @class AWEMusicModel; @class AWEAPMManager; @class AWEPlayVideoPlayerController; @class MSConfigOV; @class AWENewFeedTableViewController; @class TTHttpTask; @class AWESharePanelController; @class AWESecurityConfig; @class AWEStartupTimingMonitorManager; @class NSFileManager; @class TTKSharePanelViewController; @class NSKeyedUnarchiver; @class AWEAwemeModel; @class TTInstallSandBoxHelper; @class TTAdSplashDeviceHelper; @class AppsFlyerUtils; @class AWEShareItem; @class AWEVideoModel; @class AVMDLDataLoader; @class _TTVideoEnginePreloadManager; @class TTNetworkManagerChromium; @class TTNetworkUtil; @class MSManagerOV; 
...
static __attribute__((constructor)) void _logosLocalCtor_aa5c4279(int __unused argc, char __unused **argv, char __unused **envp) {
