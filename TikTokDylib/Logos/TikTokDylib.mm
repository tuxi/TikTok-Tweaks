...
static BOOL _logos_method$_ungrouped$AWEAwemeModel$preventDownload(_LOGOS_SELF_TYPE_NORMAL AWEAwemeModel* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    BOOL flag = _logos_orig$_ungrouped$AWEAwemeModel$preventDownload(self, _cmd);
    return flag;
}

static BOOL _logos_method$_ungrouped$AWEAwemeModel$allowDownloadWithoutWatermark(_LOGOS_SELF_TYPE_NORMAL AWEAwemeModel* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    BOOL flag = _logos_orig$_ungrouped$AWEAwemeModel$allowDownloadWithoutWatermark(self, _cmd);
    return true;
}
...
static void _logos_method$_ungrouped$AWEShareBasePanelController$notifyExtensionsWithSelector$(_LOGOS_SELF_TYPE_NORMAL AWEShareBasePanelController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, SEL arg1) {
    _logos_orig$_ungrouped$AWEShareBasePanelController$notifyExtensionsWithSelector$(self, _cmd, arg1);
}
static void _logos_method$_ungrouped$AWEShareBasePanelController$addExtension$(_LOGOS_SELF_TYPE_NORMAL AWEShareBasePanelController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1) {
    _logos_orig$_ungrouped$AWEShareBasePanelController$addExtension$(self, _cmd, arg1);
}
...
static long long _logos_method$_ungrouped$AWELongVideoControlModel$preventDownloadType(_LOGOS_SELF_TYPE_NORMAL AWELongVideoControlModel* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    bool preventDownloadType = _logos_orig$_ungrouped$AWELongVideoControlModel$preventDownloadType(self, _cmd);
...
static bool _logos_method$_ungrouped$AWELongVideoControlModel$allowDownload(_LOGOS_SELF_TYPE_NORMAL AWELongVideoControlModel* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    bool allowDownload = _logos_orig$_ungrouped$AWELongVideoControlModel$allowDownload(self, _cmd);
...
static void _logos_meta_method$_ungrouped$AWEShareServiceUtils$composeWithFileURL$awemeModel$options$watermarkTaskType$shouldMuteVideo$needSaveToAlbum$removeLocalFile$edgeData$(_LOGOS_SELF_TYPE_NORMAL Class _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1, id arg2, long long arg3, unsigned long long arg4, _Bool arg5, _Bool arg6, _Bool arg7, id arg8) {
    _logos_meta_orig$_ungrouped$AWEShareServiceUtils$composeWithFileURL$awemeModel$options$watermarkTaskType$shouldMuteVideo$needSaveToAlbum$removeLocalFile$edgeData$(self, _cmd, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
}

static void _logos_meta_method$_ungrouped$AWEShareServiceUtils$downloadVideoWithURLGoup$seed$destinationURL$progress$completionHandler$(_LOGOS_SELF_TYPE_NORMAL Class _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1, long long arg2, id arg3, id arg4, id arg5) {
    _logos_meta_orig$_ungrouped$AWEShareServiceUtils$downloadVideoWithURLGoup$seed$destinationURL$progress$completionHandler$(self, _cmd, arg1, arg2, arg3, arg4, arg5);
}
static void _logos_meta_method$_ungrouped$AWEShareServiceUtils$downloadVideoWithURLGoup$destinationURL$progress$completionHandler$(_LOGOS_SELF_TYPE_NORMAL Class _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1, id arg2, id arg3, id arg4) {
    _logos_meta_orig$_ungrouped$AWEShareServiceUtils$downloadVideoWithURLGoup$destinationURL$progress$completionHandler$(self, _cmd, arg1, arg2, arg3, arg4);
}

static void _logos_meta_method$_ungrouped$AWEShareServiceUtils$trackWatermarkShareDownloadEventWithShareType$downloadURLs$hasWatermark$hasEndWatermark$(_LOGOS_SELF_TYPE_NORMAL Class _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, long long arg1, id arg2, _Bool arg3, _Bool arg4) {
    _logos_meta_orig$_ungrouped$AWEShareServiceUtils$trackWatermarkShareDownloadEventWithShareType$downloadURLs$hasWatermark$hasEndWatermark$(self, _cmd, arg1, arg2, arg3, arg4);
}
...
static id _logos_method$_ungrouped$AWEVideoModel$downloadURL(_LOGOS_SELF_TYPE_NORMAL AWEVideoModel* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    id obj = _logos_orig$_ungrouped$AWEVideoModel$downloadURL(self, _cmd);
    return obj;
}
...
static id _logos_meta_method$_ungrouped$AWEDynamicWaterMarkExporter$endingWaterMarkLogoImage(_LOGOS_SELF_TYPE_NORMAL Class _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    id obj = _logos_meta_orig$_ungrouped$AWEDynamicWaterMarkExporter$endingWaterMarkLogoImage(self, _cmd);
    return obj;
}

static AWEAwemeModel * _logos_method$_ungrouped$AWEDynamicWaterMarkExporter$model(_LOGOS_SELF_TYPE_NORMAL AWEDynamicWaterMarkExporter* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    id obj = _logos_orig$_ungrouped$AWEDynamicWaterMarkExporter$model(self, _cmd);
    return obj;
}

static void _logos_meta_method$_ungrouped$AWEDynamicWaterMarkExporter$addWaterMarkWithUrl$composeOptions$model$shouldMuteVideo$needSaveToAlbum$userName$videoOutputSize$edgeData$canDirectAddVideoheader$progress$complete$onlyForCrop$watermarkTaskType$removeSourceFile$(_LOGOS_SELF_TYPE_NORMAL Class _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1, long long arg2, id arg3, _Bool arg4, _Bool arg5, id arg6, struct CGSize arg7, id arg8, _Bool arg9, CDUnknownBlockType arg10, CDUnknownBlockType arg11, _Bool arg12, unsigned long long arg13, _Bool arg14) {
    _logos_meta_orig$_ungrouped$AWEDynamicWaterMarkExporter$addWaterMarkWithUrl$composeOptions$model$shouldMuteVideo$needSaveToAlbum$userName$videoOutputSize$edgeData$canDirectAddVideoheader$progress$complete$onlyForCrop$watermarkTaskType$removeSourceFile$(self, _cmd, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14);
}
...
static __attribute__((constructor)) void _logosLocalCtor_e1d5be1c(int __unused argc, char __unused **argv, char __unused **envp)
{
