...
static void _logos_method$_ungrouped$AWEShareCollectionView$sendEvents$toItemAtIndexPath$(_LOGOS_SELF_TYPE_NORMAL AWEShareCollectionView* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, unsigned long long arg1, id arg2) {
    _logos_orig$_ungrouped$AWEShareCollectionView$sendEvents$toItemAtIndexPath$(self, _cmd, arg1, arg2); 
}
...
static __attribute__((constructor)) void _logosLocalCtor_6eb6e75f(int __unused argc, char __unused **argv, char __unused **envp)
{
