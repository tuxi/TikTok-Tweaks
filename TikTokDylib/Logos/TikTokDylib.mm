...
@class AWELiveGiftFansEnterView; @class AWELoginWindowManager; @class AWEFeedCellViewController; @class AWEFeedTableViewController; @class AVMDLDataLoader; @class BDDiamondAfterHeatManager; @class AWEFeedContainerViewController; @class AWELiveWalletManager; @class NSString; @class AWEUIResponder; @class AWELiveGiftListDataController; @class AWEDiscoverFeedEntranceView; @class AWEShareCollectionView; @class AWELiveMyWalletModel; @class AWESlidingTabbarView; @class AWELiveGiftListBottomLandscapeView; @class AWEIMMessageBaseViewController; @class AWEVideoRecorderController; @class AWELiveGiftListViewController; @class AWELiveSendGiftPackage; @class ANSMetadata; @class AWEAwemePlayInteractionPresenter; @class AWELiveInteractViewController; @class AWEAwemeBaseViewController; @class AWELiveFreePresentPropertyManager; @class AWELiveRoomConfigModel; @class IESLiveDeviceInfo; @class AWEENV; @class AWEAwemeDetailTableViewController; @class NSFileManager; @class HMDInfo; @class AWEAwemePlayInteractionViewController; @class AWEAppLiveSettingManager; @class AWELiveSendGiftController; @class AWELiveTrackEventManager; @class AWEAwemeModel; @class UIDevice; @class AWEAppShareSettingManager; @class AWELiveSetting; @class AWEIMMessageListViewController; @class TTInstallDeviceHelper; 
