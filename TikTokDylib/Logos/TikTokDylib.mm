...
@class AWENewFeedTableViewController; @class TTInstallSandBoxHelper; @class TIKTOKAwemeLongPressListViewController; @class AppsFlyerUtils; @class AVMDLDataLoader; @class TTKSettingsViewController; @class AWEPlayVideoPlayerController; @class UIDevice; @class AWEAwemeModel; @class TTInstallUtil; @class TTHttpRequestChromium; @class TTAdSplashDeviceHelper; @class AWEFeedContainerViewController; @class PIPOIAPStoreManager; @class AWEPlayInteractionViewController; @class TTNetworkUtil; @class _TTVideoEnginePreloadManager; @class NSString; @class AWEFeedTableViewController; @class TTHttpTask; @class TTNetworkManagerChromium; @class NSFileManager; @class TTConcurrentHttpTask; @class AWEStartupTimingMonitorManager; 
