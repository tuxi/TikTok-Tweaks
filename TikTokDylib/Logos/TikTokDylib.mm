...
@class NSString; @class TTConcurrentHttpTask; @class _TTVideoEnginePreloadManager; @class AWEFeedContainerViewController; @class AWEPlayInteractionViewController; @class TTKSettingsViewController; @class UIDevice; @class AWEPlayVideoPlayerController; @class AWEIMLongPressViewController; @class AppsFlyerUtils; @class TIKTOKAwemeLongPressListViewController; @class TTInstallSandBoxHelper; @class AWEFeedTableViewController; @class AWENewFeedTableViewController; @class AVMDLDataLoader; @class TTHttpRequestChromium; @class PIPOIAPStoreManager; @class NSFileManager; @class TTNetworkUtil; @class TTInstallUtil; @class TTHttpTask; @class TTAdSplashDeviceHelper; @class AWEAwemeModel; @class AWEStartupTimingMonitorManager; @class TTNetworkManagerChromium; 
...
__attribute__((used)) static UIButton * _logos_method$DownloadBypass$AWEIMLongPressViewController$xy_downloadBtn(AWEIMLongPressViewController * __unused self, SEL __unused _cmd) { return (UIButton *)objc_getAssociatedObject(self, (void *)_logos_method$DownloadBypass$AWEIMLongPressViewController$xy_downloadBtn); }; __attribute__((used)) static void _logos_method$DownloadBypass$AWEIMLongPressViewController$setXy_downloadBtn(AWEIMLongPressViewController * __unused self, SEL __unused _cmd, UIButton * rawValue) { objc_setAssociatedObject(self, (void *)_logos_method$DownloadBypass$AWEIMLongPressViewController$xy_downloadBtn, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }

static void _logos_method$DownloadBypass$AWEIMLongPressViewController$xy_downloadAweme(_LOGOS_SELF_TYPE_NORMAL AWEIMLongPressViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
...
static void _logos_method$SkipLiving$AWENewFeedTableViewController$viewDidLoad(_LOGOS_SELF_TYPE_NORMAL AWENewFeedTableViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(xy_needsSetPureModeNotification) name:@"xyNeedsSetPureModeNotification" object:nil];
    self.pureMode = YES;
}


static void _logos_method$SkipLiving$AWENewFeedTableViewController$xy_needsSetPureModeNotification(_LOGOS_SELF_TYPE_NORMAL AWENewFeedTableViewController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    [self setNeedsSetPureMode: XYPreferenceManager.shared.isPureMode];
}
...
static __attribute__((constructor)) void _logosLocalCtor_b7539848(int __unused argc, char __unused **argv, char __unused **envp) {
