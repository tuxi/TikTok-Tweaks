...
@class TTNetworkManagerChromium; @class AWENewFeedTableViewController; @class _TTVideoEnginePreloadManager; @class TTHttpRequestChromium; @class AWEVideoModel; @class AWEPlayInteractionViewController; @class TTInstallUtil; @class TTNetworkUtil; @class TTKSharePanelViewController; @class AWESharePanelController; @class NSString; @class TTInstallSandBoxHelper; @class AWEFeedTableViewController; @class UIDevice; @class AWEFeedContainerViewController; @class AWEPlayVideoPlayerController; @class TTConcurrentHttpTask; @class TTKSettingsViewController; @class PIPOIAPStoreManager; @class AWEStartupTimingMonitorManager; @class AVMDLDataLoader; @class NSFileManager; @class AppsFlyerUtils; @class AWEAwemeModel; @class TTHttpTask; @class TTAdSplashDeviceHelper; 
...
static NSURL * _logos_method$DownloadBypass$AWEVideoModel$xy_videoURL(_LOGOS_SELF_TYPE_NORMAL AWEVideoModel* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
...
static __attribute__((constructor)) void _logosLocalCtor_b27a7474(int __unused argc, char __unused **argv, char __unused **envp) {
