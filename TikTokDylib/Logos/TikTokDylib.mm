...
@class PIPOIAPStoreManager; @class AWEPlayVideoPlayerController; @class TTNetworkManagerChromium; @class TTInstallUtil; @class AWENewFeedTableViewController; @class AWEShareItem; @class _TTVideoEnginePreloadManager; @class AWESecurityConfig; @class TTNetworkUtil; @class AVMDLDataLoader; @class AWEPlayInteractionViewController; @class AWEFeedContainerViewController; @class TTInstallSandBoxHelper; @class AWESharePanelController; @class NSString; @class TTHttpTask; @class NSKeyedUnarchiver; @class AppsFlyerUtils; @class AWEAPMManager; @class NSFileManager; @class TTKSharePanelViewController; @class AWEMusicModel; @class TTHttpRequestChromium; @class TTKSettingsViewController; @class TTAdSplashDeviceHelper; @class GULAppEnvironmentUtil; @class AWEAwemeModel; @class AWEFeedTableViewController; @class UIDevice; @class AWEVideoModel; @class TTConcurrentHttpTask; @class AWEStartupTimingMonitorManager; 
...
static bool _logos_meta_method$JailbreakBypass$GULAppEnvironmentUtil$isAppExtension(_LOGOS_SELF_TYPE_NORMAL Class _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    ...
    BOOL res = _logos_meta_orig$JailbreakBypass$GULAppEnvironmentUtil$isAppExtension(self, _cmd);
    return YES;
}
...
static __attribute__((constructor)) void _logosLocalCtor_ba0836a8(int __unused argc, char __unused **argv, char __unused **envp) {
