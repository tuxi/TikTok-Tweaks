...
@class NSFileManager; @class TTNetworkManagerChromium; @class TTInstallSandBoxHelper; @class NSString; @class AWEPlayInteractionViewController; @class AWEIMDirectTranspondViewController; @class TTKSettingsViewController; @class AWEFeedContainerViewController; @class PIPOIAPStoreManager; @class AWEFeedTableViewController; @class TTHttpTask; @class UIDevice; @class AWEAwemeModel; @class TTHttpRequestChromium; @class _TTVideoEnginePreloadManager; @class TTConcurrentHttpTask; @class AVMDLDataLoader; @class TTInstallUtil; @class AWEPlayVideoPlayerController; @class AppsFlyerUtils; @class AWEStartupTimingMonitorManager; @class TTNetworkUtil; @class TTAdSplashDeviceHelper; 
...
static __attribute__((constructor)) void _logosLocalCtor_1b4e3bc7(int __unused argc, char __unused **argv, char __unused **envp) {
    ...
    {Class _logos_class$SkipLiving$AWEFeedTableViewController = objc_getClass("AWEFeedTableViewController"); MSHookMessageEx(_logos_class$SkipLiving$AWEFeedTableViewController, @selector(viewDidLoad), (IMP)&_logos_method$SkipLiving$AWEFeedTableViewController$viewDidLoad, (IMP*)&_logos_orig$SkipLiving$AWEFeedTableViewController$viewDidLoad);MSHookMessageEx(_logos_class$SkipLiving$AWEFeedTableViewController, @selector(playVideo:), (IMP)&_logos_method$SkipLiving$AWEFeedTableViewController$playVideo$, (IMP*)&_logos_orig$SkipLiving$AWEFeedTableViewController$playVideo$);}
