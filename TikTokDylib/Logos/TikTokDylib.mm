...
@class AWENewFeedTableViewController; @class TTHttpRequestChromium; @class AWEPlayInteractionViewController; @class AWEAwemeModel; @class UIDevice; @class NSString; @class _TTVideoEnginePreloadManager; @class AWEFeedTableViewController; @class AWEFeedContainerViewController; @class AVMDLDataLoader; @class TTAdSplashDeviceHelper; @class TIKTOKAwemeLongPressListViewController; @class PIPOIAPStoreManager; @class TTNetworkManagerChromium; @class TTNetworkUtil; @class TTInstallUtil; @class TTConcurrentHttpTask; @class TTInstallSandBoxHelper; @class NSFileManager; @class TTHttpTask; @class AWEPlayVideoPlayerController; @class AppsFlyerUtils; @class AWEStartupTimingMonitorManager; @class TTKSettingsViewController; 
