...
@class AWELiveInteractViewController; @class AWESlidingTabbarView; @class AWEAwemePlayInteractionViewController; @class AWELiveSetting; @class AWEAwemeDetailTableViewController; @class AVMDLDataLoader; @class AWELiveMyWalletModel; @class AWELiveSendGiftController; @class UIDevice; @class BDDiamondAfterHeatManager; @class AWELiveWalletManager; @class AWELiveGiftListViewController; @class AWEShareCollectionView; @class AWEFeedContainerViewController; @class AWEIMMessageBaseViewController; @class AWELiveRoomConfigModel; @class HMDInfo; @class AWELiveGiftListDataController; @class NSFileManager; @class ANSMetadata; @class AWEAppShareSettingManager; @class AWEIMMessageListViewController; @class AWEFeedTableViewController; @class AWEAwemeBaseViewController; @class NSString; @class AWELoginWindowManager; @class AWEAwemeModel; @class AWELiveGiftListBottomLandscapeView; @class AWEENV; @class AWELiveFreePresentPropertyManager; @class AWEDiscoverFeedEntranceView; @class AWEUIResponder; @class TTInstallDeviceHelper; @class AWEAppLiveSettingManager; @class AWEFeedCellViewController; @class AWEVideoRecorderController; @class AWEAwemePlayInteractionPresenter; @class AWELiveGiftFansEnterView; @class IESLiveDeviceInfo; @class AWELiveTrackEventManager; @class AWELiveSendGiftPackage; 
