...
@class UIDevice; @class AWEFeedContainerViewController; @class TTKSettingsViewController; @class TIKTOKAwemeLongPressListViewController; @class _TTVideoEnginePreloadManager; @class TTConcurrentHttpTask; @class NSString; @class TTHttpTask; @class TTAdSplashDeviceHelper; @class TTNetworkManagerChromium; @class TTHttpRequestChromium; @class TTInstallUtil; @class PIPOIAPStoreManager; @class AWEIMLongPressViewController; @class AWEFeedTableViewController; @class AWEPlayVideoPlayerController; @class AWENewFeedTableViewController; @class TTNetworkUtil; @class AWEPlayInteractionViewController; @class AppsFlyerUtils; @class AWEAwemeModel; @class AVMDLDataLoader; @class AWEStartupTimingMonitorManager; @class NSFileManager; @class TTInstallSandBoxHelper; 
