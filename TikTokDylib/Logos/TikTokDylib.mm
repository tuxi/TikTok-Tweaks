#line 1 "/Users/xiaoyuan/Desktop/TikTok/TikTokDylib/Logos/TikTokDylib.xm"
...
@class NSString; @class PIPOIAPStoreManager; @class _TTVideoEnginePreloadManager; @class TTInstallSandBoxHelper; @class AWEIMDirectTranspondViewController; @class AWEAwemeModel; @class TTAdSplashDeviceHelper; @class AppsFlyerUtils; @class TTHttpTask; @class AWEFeedTableViewController; @class AWEStartupTimingMonitorManager; @class AWEFeedContainerViewController; @class UIDevice; @class CTCarrier; @class NSFileManager; @class TTNetworkManagerChromium; @class AWEPlayVideoPlayerController; @class AWEPlayInteractionViewController; @class AVMDLDataLoader; @class TTInstallUtil; 
...
#line 16 "/Users/xiaoyuan/Desktop/TikTok/TikTokDylib/Logos/TikTokDylib.xm"
...
static __attribute__((constructor)) void _logosLocalCtor_66d3df4c(int __unused argc, char __unused **argv, char __unused **envp) {
