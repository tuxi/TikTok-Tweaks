...
@class TTKSettingsViewController; @class AWEFeedTableViewController; @class TTConcurrentHttpTask; @class AWEStartupTimingMonitorManager; @class AWEPlayVideoPlayerController; @class TIKTOKAwemeLongPressListViewController; @class _TTVideoEnginePreloadManager; @class TTHttpRequestChromium; @class AWENewFeedTableViewController; @class AppsFlyerUtils; @class TTNetworkUtil; @class TTAdSplashDeviceHelper; @class UIDevice; @class AWEAwemeModel; @class PIPOIAPStoreManager; @class AWEPlayInteractionViewController; @class AVMDLDataLoader; @class AWEFeedContainerViewController; @class TTInstallUtil; @class TTHttpTask; @class AWEIMLongPressViewController; @class TTNetworkManagerChromium; @class NSString; @class NSFileManager; @class TTInstallSandBoxHelper; 
