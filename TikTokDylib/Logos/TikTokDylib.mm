...
@class TTNetworkUtil; @class TTNetworkManagerChromium; @class PIPOIAPStoreManager; @class NSString; @class UIDevice; @class NSFileManager; @class _TTVideoEnginePreloadManager; @class AppsFlyerUtils; @class AWEPlayVideoPlayerController; @class TTHttpTask; @class TIKTOKAwemeLongPressListViewController; @class TTAdSplashDeviceHelper; @class TTInstallSandBoxHelper; @class TTKSettingsViewController; @class AWEPlayInteractionViewController; @class TTInstallUtil; @class AWEFeedContainerViewController; @class TTConcurrentHttpTask; @class AWEFeedTableViewController; @class AWEAwemeModel; @class TTHttpRequestChromium; @class AVMDLDataLoader; @class AWEStartupTimingMonitorManager; 
...
static __attribute__((constructor)) void _logosLocalCtor_6b8d4a4e(int __unused argc, char __unused **argv, char __unused **envp) {
