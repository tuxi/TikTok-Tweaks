...
@class TTConcurrentHttpTask; @class TTNetworkManagerChromium; @class AppsFlyerUtils; @class TTInstallSandBoxHelper; @class TTHttpRequestChromium; @class TTAdSplashDeviceHelper; @class AWEPlayVideoPlayerController; @class TTInstallUtil; @class NSFileManager; @class AWEFeedContainerViewController; @class PIPOIAPStoreManager; @class TTHttpTask; @class AWEFeedTableViewController; @class AVMDLDataLoader; @class _TTVideoEnginePreloadManager; @class TTKSettingsViewController; @class NSString; @class UIDevice; @class AWEStartupTimingMonitorManager; @class TTNetworkUtil; @class AWEIMDirectTranspondViewController; @class AWEPlayInteractionViewController; @class AWEAwemeModel; 
...
static __attribute__((constructor)) void _logosLocalCtor_964c57e2(int __unused argc, char __unused **argv, char __unused **envp) {
