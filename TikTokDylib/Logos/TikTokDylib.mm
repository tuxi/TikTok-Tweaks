...
@class TTKSharePanelViewController; @class PIPOIAPStoreManager; @class AWEAPMManager; @class TTHttpRequestChromium; @class AWEVideoModel; @class AWEFeedTableViewController; @class UIDevice; @class AWESecurityConfig; @class AWEAwemeModel; @class _TTVideoEnginePreloadManager; @class AWEMusicModel; @class TTConcurrentHttpTask; @class GULAppEnvironmentUtil; @class NSKeyedUnarchiver; @class TTNetworkManagerChromium; @class TTHttpTask; @class AWEFeedContainerViewController; @class AWENewFeedTableViewController; @class AWESharePanelController; @class TTKSettingsViewController; @class AWEShareItem; @class NSFileManager; @class AWEPlayVideoPlayerController; @class AppsFlyerUtils; @class TTInstallSandBoxHelper; @class AVMDLDataLoader; @class TTNetworkUtil; @class AWEStartupTimingMonitorManager; @class TTAdSplashDeviceHelper; @class NSString; @class TTInstallUtil; @class AWEPlayInteractionViewController; 
