...
@interface AWEFeedVideoButton : UIButton //<AWEAwemeFeedVideoButtonProtocol>
{
    ...
    UIImage *_lastImage;
    id _touchUpInsideBlock;
    UIImageView *_buttonImageView;
    UIView *_containerView;
    id _onMenuItemClickedBlock;
...
@property(copy, nonatomic) id onMenuItemClickedBlock; // @synthesize onMenuItemClickedBlock=_onMenuItemClickedBlock;
...
@property(copy, nonatomic) id touchUpInsideBlock; // @synthesize touchUpInsideBlock=_touchUpInsideBlock;
...
- (void)playDouPlusEntryGuideAnimationWithModel:(id)arg1 finishBlock:(id)arg2;
- (void)playGuideAnimationWithModel:(id)arg1 finishBlock:(id)arg2;
- (void)playDownloadGuideAnimationWithModel:(id)arg1 finishBlock:(id)arg2;
- (_Bool)downloadAvailableWithAwemeModel:(id)arg1;
- (void)playFavoriteGuideAnimationWithFinishBlock:(id)arg1;
