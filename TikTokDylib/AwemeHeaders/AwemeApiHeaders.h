...
// 搜索关键词 keyword 为 nil 时，将当前视频作者的名字 作为搜索关键字
// 注意：当搜索被抖音限制时，请卸载重新安装，搜索并不需要用户登陆
- (void)xy_searchWithKeyword:(nullable NSString *)keyword block:(void (^)(void))block;
...
// 自动滚动的数量
@property (nonatomic, assign) int autoScrollCount;
@property (nonatomic, assign) int maxScrollCount;
@property (nonatomic, assign) BOOL isStartPlayNext;
- (void)xy_stopAutoPlayNext;
- (void)xy_startAutoPlayNext;
- (void)xy_toggleAutoPlayNext;
